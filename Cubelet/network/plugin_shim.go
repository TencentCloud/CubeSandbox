...
func (l *local) buildEnsureNetworkRequestFromIntent(sandboxID, requestID string, exposedPorts []int64, shimReq *NetRequest, cubeNetworkConfig *networkruntime.CubeNetworkConfig, dnsAllowOutCIDRs, operatorDNSAllowOutCIDRs []string) *networkruntime.EnsureNetworkRequest {
	...
	desired.OperatorDNSAllowOutCIDRs = operatorDNSAllowOutCIDRs
