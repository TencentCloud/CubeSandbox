...
CUBE_EGRESS_PROXY_READ_TIMEOUT="${CUBE_EGRESS_PROXY_READ_TIMEOUT:-300s}"
CUBE_EGRESS_PROXY_SEND_TIMEOUT="${CUBE_EGRESS_PROXY_SEND_TIMEOUT:-${CUBE_EGRESS_PROXY_READ_TIMEOUT}}"
[[ "${CUBE_EGRESS_PROXY_READ_TIMEOUT}" =~ ^[1-9][0-9]*(ms|[smhd])$ ]] \
  || die "invalid CUBE_EGRESS_PROXY_READ_TIMEOUT: ${CUBE_EGRESS_PROXY_READ_TIMEOUT}"
[[ "${CUBE_EGRESS_PROXY_SEND_TIMEOUT}" =~ ^[1-9][0-9]*(ms|[smhd])$ ]] \
  || die "invalid CUBE_EGRESS_PROXY_SEND_TIMEOUT: ${CUBE_EGRESS_PROXY_SEND_TIMEOUT}"
upsert_env_kv "${RUNTIME_ENV_FILE}" "CUBE_EGRESS_PROXY_READ_TIMEOUT" "${CUBE_EGRESS_PROXY_READ_TIMEOUT}"
upsert_env_kv "${RUNTIME_ENV_FILE}" "CUBE_EGRESS_PROXY_SEND_TIMEOUT" "${CUBE_EGRESS_PROXY_SEND_TIMEOUT}"
