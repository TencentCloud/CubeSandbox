...
CUBE_LCM_REDIS_MASTER_NAME="${CUBE_LCM_REDIS_MASTER_NAME:-${CUBE_PROXY_REDIS_MASTER_NAME:-${CUBE_SANDBOX_REDIS_MASTER_NAME:-}}}"
CUBE_LCM_REDIS_SENTINEL_NODES="${CUBE_LCM_REDIS_SENTINEL_NODES:-${CUBE_PROXY_REDIS_SENTINEL_NODES:-${CUBE_SANDBOX_REDIS_SENTINEL_NODES:-}}}"
CUBE_LCM_REDIS_SENTINEL_PASSWORD="${CUBE_LCM_REDIS_SENTINEL_PASSWORD:-${CUBE_PROXY_REDIS_SENTINEL_PASSWORD:-${CUBE_SANDBOX_REDIS_SENTINEL_PASSWORD:-}}}"
