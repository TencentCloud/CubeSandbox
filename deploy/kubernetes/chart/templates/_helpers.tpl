...
http {
    ...
    server {
        ...
        location = /opsapi/v1/terminal/ws {
            ...
            proxy_pass {{ $opsUpstream }}/api/v1/terminal/ws;
        }
...
{{- define "cube.terminalSecretName" -}}
{{- if .Values.terminal.existingSecret -}}
{{- .Values.terminal.existingSecret -}}
{{- else -}}
{{- printf "%s-terminal" (include "cube.fullname" .) -}}
{{- end -}}
{{- end -}}
