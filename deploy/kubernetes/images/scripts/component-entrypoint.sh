...
# Patch mvm_mtu in a Cubelet config.toml from CUBE_SANDBOX_NETWORK_MTU. Shared
# by run_network_agent and run_cubelet; cube-node-entrypoint.sh keeps its own
# copy because the two scripts are self-contained.
patch_cubelet_mtu() {
  local cfg="$1"
