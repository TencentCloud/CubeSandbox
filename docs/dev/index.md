...
- [Snapshot Lifecycle Event Contract](./snapshot-lifecycle-events) — the proposed structured events, payload fields, and success-only emission rules for snapshot create, rollback, and delete operations.
