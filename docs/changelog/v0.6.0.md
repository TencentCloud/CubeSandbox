...
Isolate a node with `cubeopscli node isolate <node-id>`, and lift isolation with the `unisolate` subcommand. For details, see [Node Isolation](https://cubesandbox.com/guide/node-isolation.html).
