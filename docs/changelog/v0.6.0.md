...
Isolate a node with `cubemastercli node isolate <node-id>`, and lift isolation with the `unisolate` subcommand. For details, see [Node Operations](https://cubesandbox.com/guide/node-operations.html).
