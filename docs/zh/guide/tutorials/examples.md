...
| [PHP + Composer 沙箱](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/php-composer-sandbox) | 内置 Composer 的 PHP Web 开发模板，提供最小 JSON API、CubeProxy 访问，以及暂停/恢复后的工作区状态保留校验。 |
