...
| [Agent 工具白名单沙箱](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/agent-tool-allowlist-sandbox) | 自包含示例：BYOI 工具集镜像 + 宿主机 argv 白名单、deny/allow 演示、单测与固定提案参考环（#645）。 |
