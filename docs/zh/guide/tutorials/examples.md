...
| [CodeBuddy 集成](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/codebuddy-integration) | 将 CodeBuddy CLI 作为 headless 终端型编码 Agent 运行在 Cube Sandbox 中，包含模板构建、凭据注入和暂停/恢复验证。 |
