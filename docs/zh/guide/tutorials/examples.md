...
| [Agent 工具白名单（BYOI）](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/agent-tool-allowlist-sandbox) | 可构建工具集画像镜像 + quickstart 宿主机 argv 门控脚本；对应 #645 模板+示例门槛。 |
