...
| [Ruby + Sinatra 沙箱](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/ruby-sinatra-sandbox) | 构建可复用的 Ruby Web 模板，运行有状态 Sinatra API，并验证 pause/resume 后工作区状态仍然保留。 |
