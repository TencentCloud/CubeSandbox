...
| [Node.js / Fastify Web 模板](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/node-fastify-web-template) | 在 CubeSandbox 中运行 TypeScript Fastify Web API，演示端口暴露、有状态工作区与快照恢复。 |
