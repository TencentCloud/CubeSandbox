...
| [Agent 工具白名单沙箱](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/agent-tool-allowlist-sandbox) | BYOI 受限工具箱：guest `cube-tool` + `toolbox-hello` 负载；宿主 argv 门控；主路径 `python run.py`（#645）。 |
