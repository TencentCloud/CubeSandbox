...
| [Agent Tool Allowlist Sandbox](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/agent-tool-allowlist-sandbox) | BYOI restricted toolbox: in-guest `cube-tool` + `toolbox-hello` workload; host argv gate; happy path `python run.py` (#645). |
