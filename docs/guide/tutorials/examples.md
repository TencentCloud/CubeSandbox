...
| [CodeBuddy Integration](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/codebuddy-integration) | Run CodeBuddy CLI as a headless terminal coding agent inside Cube Sandbox, with template build scripts, secure credential injection, and pause/resume validation. |
