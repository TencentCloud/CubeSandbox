...
| [Rust Sandbox](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/rust-sandbox) | Compile, build, and run Rust code inside an isolated MicroVM. Ships a pre-installed Rust toolchain, pre-warmed crate registry, and five demo scripts covering snippet execution, Cargo project management, snapshot-accelerated incremental builds, axum web services, and secure untrusted-code evaluation with network isolation. |
