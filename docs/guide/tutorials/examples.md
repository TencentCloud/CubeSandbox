...
| [PHP + Composer Sandbox](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/php-composer-sandbox) | PHP web-development template with Composer, a minimal JSON API, CubeProxy access, and a pause/resume workspace-persistence check. |
