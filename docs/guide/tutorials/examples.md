...
| [Ruby + Sinatra Sandbox](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/ruby-sinatra-sandbox) | Build a reusable Ruby web template, expose a stateful Sinatra API, and verify workspace persistence across pause/resume. |
