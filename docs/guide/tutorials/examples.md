...
| [Agent Tool Allowlist Sandbox](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/agent-tool-allowlist-sandbox) | Self-contained example: BYOI toolbox image + host argv allowlist, stacked with airgap/CIDR egress, pause/resume checkpoint, and multi-sandbox fan-out (#645). |
