...
| [Webhook Receiver](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/webhook-receiver) | Dependency-free Python receiver with HMAC-SHA256 verification, a signed test sender, and optional WeCom group robot forwarding. |

::: tip
Sandbox SDK examples share the environment variable conventions (`E2B_API_URL`, `E2B_API_KEY`, `CUBE_TEMPLATE_ID`). Control-plane integration examples such as the Webhook receiver document their own variables. See the [Quick Start](../quickstart.md) guide to set up your Cube Sandbox deployment first.
:::
