...
| [Jupyter ML Sandbox](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/jupyter-ml-sandbox) | JupyterLab-based data science and ML template with pandas, scikit-learn, seaborn, and CPU PyTorch. Includes notebook execution and pause/resume persistence checks. |
