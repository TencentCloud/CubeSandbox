...
| [Crash Recovery Worker](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/crash-recovery-worker) | Run a long-lived stateful Worker through repeated checkpoint, crash, rollback, and replay epochs while verifying process memory and the writable workspace after every transfer. |
