...
| [Scenario Demos (Rust Playground)](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/rust-playground) | Four CubeSandbox scenarios — stateful workspace lifecycle, egress policy enforcement, checkpoint-driven iterative development (snapshot/clone/rollback), and multi-sandbox collaboration with role-based network isolation. |
