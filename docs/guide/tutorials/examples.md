...
| [Rust Playground](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/rust-playground) | Compile and run Rust code inside a sandbox — from one-off `rustc` scripts to full Cargo projects with dependencies. Showcases CubeCoW snapshot, clone, and rollback during iterative development. |
