...
| [Go Runtime Template](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/go-runtime-template) | Template-authoring example: build a Cube-ready Go runtime image on top of `cubesandbox-base`, verify `envd`, and run `go version`, `go test`, and `go run` from a sandbox workspace. |
| [Rust Runtime Template](https://github.com/tencentcloud/CubeSandbox/tree/master/examples/rust-runtime-template) | Template-authoring example: build a Cube-ready Rust runtime image on top of `cubesandbox-base`, verify `envd`, and run `rustc`, `cargo test`, and `cargo run` from a sandbox workspace. |
