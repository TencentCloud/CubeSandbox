...
type SnapshotNode struct {
	...
	// Physical CPU core count (NOT milli-cores). The quota_cpu/allocated_cpu
	// fields below and RequestContext.cpu_millis are milli-cores; convert
	// before comparing capacity.
	...
	// In-flight reservation. Not populated today (always 0); reserved for
	// future reservation management.
	Reserved      int64 `protobuf:"varint,24,opt,name=reserved,proto3" json:"reserved,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
