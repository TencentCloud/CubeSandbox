...
ART
      ...
      printf '  * Install cmd   : curl -sL https://github.com/tencentcloud/CubeSandbox/raw/master/deploy/one-click/online-install.sh | MIRROR=cn bash\n'
      printf '  * Cube API      : http://127.0.0.1:3000 (forwarded to the host)\n'
      printf '\n'
