...
use crate::{
    handlers,
    models::{
        ApiError, ConnectSandbox, ConnectSandboxV2, CreateSnapshotRequest, CreateTemplateRequest,
        NewSandbox, NewSandboxV2, NewVolume, RebuildTemplateRequest, RefreshRequest,
...
#[openapi(
    ...
    paths(
        ...
        handlers::sandboxes::create_sandbox_v2,
        ...
        handlers::sandboxes::connect_sandbox_v2,
