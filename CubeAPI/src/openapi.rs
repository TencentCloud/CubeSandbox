...
use crate::{
    ...
    models::{
        ...
        ComponentVersionView, ControlPlaneVersionView, CreateTemplateRequest,
        NodeComponentEntryView, NodeConditionView, NodeResourcesView, NodeVersionRowView, NodeView,
        ResumedSandbox, Sandbox, SandboxDetail, SandboxLogEntry, SandboxLogsV2Response,
        SandboxState, SandboxVolumeMount, TemplateBuildJob, TemplateCompatAdoptResponseView,
        TemplateCompatMatrixView, TemplateCompatRowView, TemplateCompatSummaryView, TemplateDetail,
        TemplateNameLookupResponse, TemplateNodeCompatView, TemplateSummary, UpdateTemplateRequest,
        VersionMatrixView,
    },
};
...
#[openapi(
    ...
    paths(
        ...
        handlers::templates::lookup_template_name,
