...
import { Pause, Play, Trash2, Search, Plus, TerminalIcon } from 'lucide-react';
...
export default function SandboxesPage() {
  ...
  return (
    <div className="animate-fade-in space-y-5">
      ...
      <Card className="!p-0 overflow-hidden">
        ...
        {filtered.map((sb) => (
          <Row
            ...
            onTerminal={() => setTerminalSandbox(sb.sandboxID)}
      ...
      {terminalSandbox && (
        <TerminalPanel
          sandboxID={terminalSandbox}
          open={!!terminalSandbox}
    ...
    <div className="grid grid-cols-[120px_minmax(200px,1.2fr)_minmax(160px,1fr)_110px_120px_130px_120px_120px] gap-2 border-b border-border/60 px-4 py-3 text-sm transition hover:bg-muted/50">
      ...
      <div className="flex justify-end gap-1">
        ...
        <Button
          size="icon"
          variant="ghost"
          title={state !== 'running' ? t('terminal.error.sandboxNotRunning') : t('actions.terminal')}
          onClick={onTerminal}
