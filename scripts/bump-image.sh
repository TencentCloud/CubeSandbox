...
COMPONENTS='cube-egress|cube-egress-net|cube-master|cubemastercli|cube-api|cube-ops|cube-proxy|cube-webui|cube-lifecycle-manager|eviction-webhook|cubelet|cube-shim|cube-kernel|cube-guest|cube-node-init|cube-wait-node-prep|cube-pvm-host-bootstrap'
