...
type CubeboxMgrClient interface {
	...
	// AttachTerminal creates an interactive TTY process and streams terminal I/O.
	// The first client frame must be an `open` frame; subsequent frames carry
	// stdin bytes or terminal size updates. One stream maps to one process.
