...
type TerminalClientFrame struct {
	...
	//
	//	*TerminalClientFrame_Open
	//	*TerminalClientFrame_Stdin
	//	*TerminalClientFrame_Resize
	//	*TerminalClientFrame_Close
	Frame         isTerminalClientFrame_Frame `protobuf_oneof:"frame"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TerminalClientFrame) GetFrame() isTerminalClientFrame_Frame {
	if x != nil {
		return x.Frame
	}
	return nil
...
func (x *TerminalClientFrame) GetOpen() *TerminalOpen {
	if x != nil {
		if x, ok := x.Frame.(*TerminalClientFrame_Open); ok {
			return x.Open
		}
	}
	return nil
...
func (x *TerminalClientFrame) GetStdin() []byte {
	if x != nil {
		if x, ok := x.Frame.(*TerminalClientFrame_Stdin); ok {
			return x.Stdin
		}
	}
	return nil
...
func (x *TerminalClientFrame) GetResize() *TerminalResize {
	if x != nil {
		if x, ok := x.Frame.(*TerminalClientFrame_Resize); ok {
			return x.Resize
		}
	}
	return nil
...
func (x *TerminalClientFrame) GetClose() *TerminalClose {
	if x != nil {
		if x, ok := x.Frame.(*TerminalClientFrame_Close); ok {
			return x.Close
		}
	}
	return nil
...
type isTerminalClientFrame_Frame interface {
	isTerminalClientFrame_Frame()
}

type TerminalClientFrame_Open struct {
	// open starts the session. Only valid as the first frame.
	Open *TerminalOpen `protobuf:"bytes,1,opt,name=open,proto3,oneof"`
}

type TerminalClientFrame_Stdin struct {
	// stdin carries raw bytes typed by the user. Frames larger than the
	// negotiated limit (64 KiB) are rejected.
...
type TerminalClientFrame_Close struct {
	// close asks cubelet to terminate the session with the given reason.
	Close *TerminalClose `protobuf:"bytes,4,opt,name=close,proto3,oneof"`
}

func (*TerminalClientFrame_Open) isTerminalClientFrame_Frame() {}

func (*TerminalClientFrame_Stdin) isTerminalClientFrame_Frame() {}

func (*TerminalClientFrame_Resize) isTerminalClientFrame_Frame() {}

func (*TerminalClientFrame_Close) isTerminalClientFrame_Frame() {}
...
type TerminalOpen struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// requestID reqID, for cross-service log correlation.
	RequestId string `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	// ID of the sandbox that hosts the target container.
	SandboxId string `protobuf:"bytes,2,opt,name=sandbox_id,json=sandboxId,proto3" json:"sandbox_id,omitempty"`
	// ID of the container to attach to. Empty selects the sandbox's first
	// (primary) container.
	ContainerId string `protobuf:"bytes,3,opt,name=container_id,json=containerId,proto3" json:"container_id,omitempty"`
	...
	// Session identifier minted by the caller, used as the audit key and as the
	// basis of the containerd exec id.
	SessionId string `protobuf:"bytes,6,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
	// resume, when set, re-attaches to a session that is still within its
	// detached grace window instead of starting a new PTY.
	Resume        *TerminalResume `protobuf:"bytes,7,opt,name=resume,proto3" json:"resume,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TerminalOpen) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *TerminalOpen) GetSandboxId() string {
	if x != nil {
		return x.SandboxId
	}
	return ""
...
func (x *TerminalOpen) GetContainerId() string {
	if x != nil {
		return x.ContainerId
	}
	return ""
...
func (x *TerminalOpen) GetResume() *TerminalResume {
	if x != nil {
		return x.Resume
	}
	return nil
...
func (x *TerminalResume) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TerminalResume) ProtoMessage() {}

func (x *TerminalResume) ProtoReflect() protoreflect.Message {
	mi := &file_api_services_cubebox_v1_cubebox_proto_msgTypes[58]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TerminalResume.ProtoReflect.Descriptor instead.
func (*TerminalResume) Descriptor() ([]byte, []int) {
	return file_api_services_cubebox_v1_cubebox_proto_rawDescGZIP(), []int{58}
}

func (x *TerminalResume) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *TerminalResume) GetLastOffset() uint64 {
	if x != nil {
		return x.LastOffset
	}
	return 0
...
type TerminalClose struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Stable close reason, e.g. "USER_CLOSED" / "IDLE_TIMEOUT" /
	// "SANDBOX_TRANSITION". Never carries internal addresses or paths.
...
type TerminalServerFrame struct {
	...
	// Types that are valid to be assigned to Frame:
	//
	//	*TerminalServerFrame_Opened
	//	*TerminalServerFrame_Stdout
	//	*TerminalServerFrame_Exit
	//	*TerminalServerFrame_Error
	//	*TerminalServerFrame_Close
	Frame         isTerminalServerFrame_Frame `protobuf_oneof:"frame"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TerminalServerFrame) GetFrame() isTerminalServerFrame_Frame {
	if x != nil {
		return x.Frame
	}
	return nil
...
func (x *TerminalServerFrame) GetOpened() *TerminalOpened {
	if x != nil {
		if x, ok := x.Frame.(*TerminalServerFrame_Opened); ok {
			return x.Opened
		}
	}
	return nil
...
func (x *TerminalServerFrame) GetStdout() *TerminalStdout {
	if x != nil {
		if x, ok := x.Frame.(*TerminalServerFrame_Stdout); ok {
			return x.Stdout
		}
	}
	return nil
...
func (x *TerminalServerFrame) GetExit() *TerminalExit {
	if x != nil {
		if x, ok := x.Frame.(*TerminalServerFrame_Exit); ok {
			return x.Exit
		}
	}
	return nil
...
func (x *TerminalServerFrame) GetError() *TerminalError {
	if x != nil {
		if x, ok := x.Frame.(*TerminalServerFrame_Error); ok {
			return x.Error
		}
	}
	return nil
...
func (x *TerminalServerFrame) GetClose() *TerminalClose {
	if x != nil {
		if x, ok := x.Frame.(*TerminalServerFrame_Close); ok {
			return x.Close
		}
	}
	return nil
...
type isTerminalServerFrame_Frame interface {
	isTerminalServerFrame_Frame()
}

type TerminalServerFrame_Opened struct {
	// opened acknowledges that the PTY is running. Always the first frame.
	Opened *TerminalOpened `protobuf:"bytes,1,opt,name=opened,proto3,oneof"`
}

type TerminalServerFrame_Stdout struct {
	// stdout carries terminal output. Under a TTY stderr is merged into it.
	Stdout *TerminalStdout `protobuf:"bytes,2,opt,name=stdout,proto3,oneof"`
}

type TerminalServerFrame_Exit struct {
	// exit reports the shell's exit status.
	Exit *TerminalExit `protobuf:"bytes,3,opt,name=exit,proto3,oneof"`
}

type TerminalServerFrame_Error struct {
	// error reports a stable failure code before or during the session.
	Error *TerminalError `protobuf:"bytes,4,opt,name=error,proto3,oneof"`
}

type TerminalServerFrame_Close struct {
	// close reports that cubelet terminated the session.
	Close *TerminalClose `protobuf:"bytes,5,opt,name=close,proto3,oneof"`
}

func (*TerminalServerFrame_Opened) isTerminalServerFrame_Frame() {}

func (*TerminalServerFrame_Stdout) isTerminalServerFrame_Frame() {}

func (*TerminalServerFrame_Exit) isTerminalServerFrame_Frame() {}

func (*TerminalServerFrame_Error) isTerminalServerFrame_Frame() {}

func (*TerminalServerFrame_Close) isTerminalServerFrame_Frame() {}

// TerminalOpened acknowledges a started session.
type TerminalOpened struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// ID of the established session, echoed for correlation.
	SessionId string `protobuf:"bytes,1,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
	// Absolute stdout offset the following stdout frames start from. Non-zero
	// only when resuming.
	ReplayFrom uint64 `protobuf:"varint,2,opt,name=replay_from,json=replayFrom,proto3" json:"replay_from,omitempty"`
	// True when the resume cursor fell behind the replay buffer and some output
	// was dropped.
	ReplayTruncated bool `protobuf:"varint,3,opt,name=replay_truncated,json=replayTruncated,proto3" json:"replay_truncated,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *TerminalOpened) Reset() {
	*x = TerminalOpened{}
...
func (x *TerminalOpened) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TerminalOpened) ProtoMessage() {}

func (x *TerminalOpened) ProtoReflect() protoreflect.Message {
	mi := &file_api_services_cubebox_v1_cubebox_proto_msgTypes[62]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TerminalOpened.ProtoReflect.Descriptor instead.
func (*TerminalOpened) Descriptor() ([]byte, []int) {
	return file_api_services_cubebox_v1_cubebox_proto_rawDescGZIP(), []int{62}
}

func (x *TerminalOpened) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *TerminalOpened) GetReplayFrom() uint64 {
	if x != nil {
		return x.ReplayFrom
	}
	return 0
...
func (x *TerminalOpened) GetReplayTruncated() bool {
	if x != nil {
...
type TerminalStdout struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Raw output bytes.
	Data []byte `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
	// Absolute offset of the first byte of `data` within the session's output
	// stream, used as the resume cursor.
	Offset        uint64 `protobuf:"varint,2,opt,name=offset,proto3" json:"offset,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TerminalStdout) Reset() {
	*x = TerminalStdout{}
...
func (x *TerminalStdout) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TerminalStdout) ProtoMessage() {}

func (x *TerminalStdout) ProtoReflect() protoreflect.Message {
	mi := &file_api_services_cubebox_v1_cubebox_proto_msgTypes[63]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TerminalStdout.ProtoReflect.Descriptor instead.
func (*TerminalStdout) Descriptor() ([]byte, []int) {
	return file_api_services_cubebox_v1_cubebox_proto_rawDescGZIP(), []int{63}
}

func (x *TerminalStdout) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *TerminalStdout) GetOffset() uint64 {
	if x != nil {
		return x.Offset
	}
	return 0
...
type TerminalError struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Stable error code, e.g. "TARGET_NOT_RUNNING" / "SHELL_NOT_FOUND" /
	// "LIMIT_EXCEEDED". Never carries internal addresses, paths or credentials.
...
func (x *CleanupOrphanStorageFilesRequest) Reset() {
	*x = CleanupOrphanStorageFilesRequest{}
	mi := &file_api_services_cubebox_v1_cubebox_proto_msgTypes[89]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CleanupOrphanStorageFilesRequest) Descriptor() ([]byte, []int) {
	return file_api_services_cubebox_v1_cubebox_proto_rawDescGZIP(), []int{89}
}
...
func (x *StorageOrphanEntry) Reset() {
	*x = StorageOrphanEntry{}
	mi := &file_api_services_cubebox_v1_cubebox_proto_msgTypes[90]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StorageOrphanEntry) Descriptor() ([]byte, []int) {
	return file_api_services_cubebox_v1_cubebox_proto_rawDescGZIP(), []int{90}
}
...
func (x *CleanupOrphanStorageFilesResponse) Reset() {
	*x = CleanupOrphanStorageFilesResponse{}
	mi := &file_api_services_cubebox_v1_cubebox_proto_msgTypes[91]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CleanupOrphanStorageFilesResponse) Descriptor() ([]byte, []int) {
	return file_api_services_cubebox_v1_cubebox_proto_rawDescGZIP(), []int{91}
}
...
const file_api_services_cubebox_v1_cubebox_proto_rawDesc = "" +
	...
	"\trequestID\x18\x01 \x01(\tR\trequestID\x124\n" +
	"\x03ret\x18\x02 \x01(\v2\".cubelet.services.errorcode.v1.RetR\x03ret\"\x82\x02\n" +
	"\x13TerminalClientFrame\x12?\n" +
	"\x04open\x18\x01 \x01(\v2).cubelet.services.cubebox.v1.TerminalOpenH\x00R\x04open\x12\x16\n" +
	...
	"\x05close\x18\x04 \x01(\v2*.cubelet.services.cubebox.v1.TerminalCloseH\x00R\x05closeB\a\n" +
	"\x05frame\"\xfb\x01\n" +
	...
	"\n" +
	"session_id\x18\x06 \x01(\tR\tsessionId\x12C\n" +
	"\x06resume\x18\a \x01(\v2+.cubelet.services.cubebox.v1.TerminalResumeR\x06resume\"P\n" +
	"\x0eTerminalResume\x12\x1d\n" +
	"\n" +
	...
	"\x06reason\x18\x01 \x01(\tR\x06reason\"\xf5\x02\n" +
	"\x13TerminalServerFrame\x12E\n" +
	"\x06opened\x18\x01 \x01(\v2+.cubelet.services.cubebox.v1.TerminalOpenedH\x00R\x06opened\x12E\n" +
	"\x06stdout\x18\x02 \x01(\v2+.cubelet.services.cubebox.v1.TerminalStdoutH\x00R\x06stdout\x12?\n" +
	"\x04exit\x18\x03 \x01(\v2).cubelet.services.cubebox.v1.TerminalExitH\x00R\x04exit\x12B\n" +
	"\x05error\x18\x04 \x01(\v2*.cubelet.services.cubebox.v1.TerminalErrorH\x00R\x05error\x12B\n" +
	"\x05close\x18\x05 \x01(\v2*.cubelet.services.cubebox.v1.TerminalCloseH\x00R\x05closeB\a\n" +
	"\x05frame\"{\n" +
	"\x0eTerminalOpened\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12\x1f\n" +
	"\vreplay_from\x18\x02 \x01(\x04R\n" +
	"replayFrom\x12)\n" +
	"\x10replay_truncated\x18\x03 \x01(\bR\x0freplayTruncated\"<\n" +
	"\x0eTerminalStdout\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\x12\x16\n" +
	"\x06offset\x18\x02 \x01(\x04R\x06offset\"+\n" +
	"\fTerminalExit\x12\x1b\n" +
	"\texit_code\x18\x01 \x01(\x05R\bexitCode\"#\n" +
	"\rTerminalError\x12\x12\n" +
	...
	"\x10CONTAINER_PAUSED\x10\x052\xfe\x0f\n" +
	"\n" +
	"CubeboxMgr\x12q\n" +
	...
	"\x04Exec\x123.cubelet.services.cubebox.v1.ExecCubeSandboxRequest\x1a4.cubelet.services.cubebox.v1.ExecCubeSandboxResponse\x12r\n" +
	"\bTerminal\x120.cubelet.services.cubebox.v1.TerminalClientFrame\x1a0.cubelet.services.cubebox.v1.TerminalServerFrame(\x010\x01\x12p\n" +
...
var file_api_services_cubebox_v1_cubebox_proto_msgTypes = make([]protoimpl.MessageInfo, 105)
var file_api_services_cubebox_v1_cubebox_proto_goTypes = []any{
	...
	(*TerminalClientFrame)(nil),               // 62: cubelet.services.cubebox.v1.TerminalClientFrame
	(*TerminalOpen)(nil),                      // 63: cubelet.services.cubebox.v1.TerminalOpen
	(*TerminalResume)(nil),                    // 64: cubelet.services.cubebox.v1.TerminalResume
	(*TerminalResize)(nil),                    // 65: cubelet.services.cubebox.v1.TerminalResize
	(*TerminalClose)(nil),                     // 66: cubelet.services.cubebox.v1.TerminalClose
	(*TerminalServerFrame)(nil),               // 67: cubelet.services.cubebox.v1.TerminalServerFrame
	(*TerminalOpened)(nil),                    // 68: cubelet.services.cubebox.v1.TerminalOpened
	(*TerminalStdout)(nil),                    // 69: cubelet.services.cubebox.v1.TerminalStdout
	(*TerminalExit)(nil),                      // 70: cubelet.services.cubebox.v1.TerminalExit
	(*TerminalError)(nil),                     // 71: cubelet.services.cubebox.v1.TerminalError
	(*AppSnapshotRequest)(nil),                // 72: cubelet.services.cubebox.v1.AppSnapshotRequest
	(*AppSnapshotResponse)(nil),               // 73: cubelet.services.cubebox.v1.AppSnapshotResponse
	(*CommitSandboxRequest)(nil),              // 74: cubelet.services.cubebox.v1.CommitSandboxRequest
	(*CommitSandboxResponse)(nil),             // 75: cubelet.services.cubebox.v1.CommitSandboxResponse
	(*RollbackSandboxRequest)(nil),            // 76: cubelet.services.cubebox.v1.RollbackSandboxRequest
	(*RollbackSandboxResponse)(nil),           // 77: cubelet.services.cubebox.v1.RollbackSandboxResponse
	(*CowObjectRef)(nil),                      // 78: cubelet.services.cubebox.v1.CowObjectRef
	(*CleanupTemplateRequest)(nil),            // 79: cubelet.services.cubebox.v1.CleanupTemplateRequest
	(*CleanupTemplateResponse)(nil),           // 80: cubelet.services.cubebox.v1.CleanupTemplateResponse
	(*ListSandboxSnapshotsRequest)(nil),       // 81: cubelet.services.cubebox.v1.ListSandboxSnapshotsRequest
	(*CowObjectStatus)(nil),                   // 82: cubelet.services.cubebox.v1.CowObjectStatus
	(*ListSandboxSnapshotsResponse)(nil),      // 83: cubelet.services.cubebox.v1.ListSandboxSnapshotsResponse
	(*ListLocalSnapshotsRequest)(nil),         // 84: cubelet.services.cubebox.v1.ListLocalSnapshotsRequest
	(*LocalSnapshotInfo)(nil),                 // 85: cubelet.services.cubebox.v1.LocalSnapshotInfo
	(*ListLocalSnapshotsResponse)(nil),        // 86: cubelet.services.cubebox.v1.ListLocalSnapshotsResponse
	(*GetLocalSnapshotRequest)(nil),           // 87: cubelet.services.cubebox.v1.GetLocalSnapshotRequest
	(*GetLocalSnapshotResponse)(nil),          // 88: cubelet.services.cubebox.v1.GetLocalSnapshotResponse
	(*GetStorageMetricsRequest)(nil),          // 89: cubelet.services.cubebox.v1.GetStorageMetricsRequest
	(*GetStorageMetricsResponse)(nil),         // 90: cubelet.services.cubebox.v1.GetStorageMetricsResponse
	(*StorageVolumeInfo)(nil),                 // 91: cubelet.services.cubebox.v1.StorageVolumeInfo
	(*SandboxStorageInfo)(nil),                // 92: cubelet.services.cubebox.v1.SandboxStorageInfo
	(*InspectStorageVolumesRequest)(nil),      // 93: cubelet.services.cubebox.v1.InspectStorageVolumesRequest
	(*InspectStorageVolumesResponse)(nil),     // 94: cubelet.services.cubebox.v1.InspectStorageVolumesResponse
	(*CleanupOrphanStorageFilesRequest)(nil),  // 95: cubelet.services.cubebox.v1.CleanupOrphanStorageFilesRequest
	(*StorageOrphanEntry)(nil),                // 96: cubelet.services.cubebox.v1.StorageOrphanEntry
	(*CleanupOrphanStorageFilesResponse)(nil), // 97: cubelet.services.cubebox.v1.CleanupOrphanStorageFilesResponse
	nil,                          // 98: cubelet.services.cubebox.v1.ContainerConfig.SysctlsEntry
	nil,                          // 99: cubelet.services.cubebox.v1.ContainerConfig.AnnotationsEntry
	nil,                          // 100: cubelet.services.cubebox.v1.PluginVolumeSource.OptionsEntry
	nil,                          // 101: cubelet.services.cubebox.v1.RunCubeSandboxRequest.AnnotationsEntry
	nil,                          // 102: cubelet.services.cubebox.v1.RunCubeSandboxRequest.LabelsEntry
	nil,                          // 103: cubelet.services.cubebox.v1.RunCubeSandboxResponse.ExtInfoEntry
	nil,                          // 104: cubelet.services.cubebox.v1.DestroyCubeSandboxRequest.AnnotationsEntry
	nil,                          // 105: cubelet.services.cubebox.v1.DestroyCubeSandboxResponse.ExtInfoEntry
	nil,                          // 106: cubelet.services.cubebox.v1.CubeSandbox.LabelsEntry
	nil,                          // 107: cubelet.services.cubebox.v1.Container.LabelsEntry
	nil,                          // 108: cubelet.services.cubebox.v1.CubeSandboxFilter.LabelSelectorEntry
	nil,                          // 109: cubelet.services.cubebox.v1.UpdateCubeSandboxRequest.AnnotationsEntry
	nil,                          // 110: cubelet.services.cubebox.v1.GetStorageMetricsResponse.MetricsEntry
	(*v1.ImageSpec)(nil),         // 111: cubelet.services.images.v1.ImageSpec
	(*v1.ImageVolumeSource)(nil), // 112: cubelet.services.images.v1.ImageVolumeSource
	(*v11.Ret)(nil),              // 113: cubelet.services.errorcode.v1.Ret
}
var file_api_services_cubebox_v1_cubebox_proto_depIdxs = []int32{
	...
	111, // 15: cubelet.services.cubebox.v1.ContainerConfig.image:type_name -> cubelet.services.images.v1.ImageSpec
	...
	98,  // 22: cubelet.services.cubebox.v1.ContainerConfig.sysctls:type_name -> cubelet.services.cubebox.v1.ContainerConfig.SysctlsEntry
	...
	99,  // 25: cubelet.services.cubebox.v1.ContainerConfig.annotations:type_name -> cubelet.services.cubebox.v1.ContainerConfig.AnnotationsEntry
	...
	112, // 39: cubelet.services.cubebox.v1.VolumeSource.image:type_name -> cubelet.services.images.v1.ImageVolumeSource
	38,  // 40: cubelet.services.cubebox.v1.VolumeSource.plugin_volume:type_name -> cubelet.services.cubebox.v1.PluginVolumeSource
	100, // 41: cubelet.services.cubebox.v1.PluginVolumeSource.options:type_name -> cubelet.services.cubebox.v1.PluginVolumeSource.OptionsEntry
	...
	101, // 45: cubelet.services.cubebox.v1.RunCubeSandboxRequest.annotations:type_name -> cubelet.services.cubebox.v1.RunCubeSandboxRequest.AnnotationsEntry
	102, // 46: cubelet.services.cubebox.v1.RunCubeSandboxRequest.labels:type_name -> cubelet.services.cubebox.v1.RunCubeSandboxRequest.LabelsEntry
	...
	113, // 48: cubelet.services.cubebox.v1.RunCubeSandboxResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	103, // 49: cubelet.services.cubebox.v1.RunCubeSandboxResponse.ext_info:type_name -> cubelet.services.cubebox.v1.RunCubeSandboxResponse.ExtInfoEntry
	...
	104, // 55: cubelet.services.cubebox.v1.DestroyCubeSandboxRequest.annotations:type_name -> cubelet.services.cubebox.v1.DestroyCubeSandboxRequest.AnnotationsEntry
	...
	113, // 57: cubelet.services.cubebox.v1.DestroyCubeSandboxResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	105, // 58: cubelet.services.cubebox.v1.DestroyCubeSandboxResponse.ext_info:type_name -> cubelet.services.cubebox.v1.DestroyCubeSandboxResponse.ExtInfoEntry
	...
	106, // 61: cubelet.services.cubebox.v1.CubeSandbox.labels:type_name -> cubelet.services.cubebox.v1.CubeSandbox.LabelsEntry
	...
	107, // 64: cubelet.services.cubebox.v1.Container.labels:type_name -> cubelet.services.cubebox.v1.Container.LabelsEntry
	...
	108, // 67: cubelet.services.cubebox.v1.CubeSandboxFilter.label_selector:type_name -> cubelet.services.cubebox.v1.CubeSandboxFilter.LabelSelectorEntry
	...
	109, // 71: cubelet.services.cubebox.v1.UpdateCubeSandboxRequest.annotations:type_name -> cubelet.services.cubebox.v1.UpdateCubeSandboxRequest.AnnotationsEntry
	113, // 72: cubelet.services.cubebox.v1.UpdateCubeSandboxResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	113, // 73: cubelet.services.cubebox.v1.ExecCubeSandboxResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	63,  // 74: cubelet.services.cubebox.v1.TerminalClientFrame.open:type_name -> cubelet.services.cubebox.v1.TerminalOpen
	65,  // 75: cubelet.services.cubebox.v1.TerminalClientFrame.resize:type_name -> cubelet.services.cubebox.v1.TerminalResize
	66,  // 76: cubelet.services.cubebox.v1.TerminalClientFrame.close:type_name -> cubelet.services.cubebox.v1.TerminalClose
	64,  // 77: cubelet.services.cubebox.v1.TerminalOpen.resume:type_name -> cubelet.services.cubebox.v1.TerminalResume
	68,  // 78: cubelet.services.cubebox.v1.TerminalServerFrame.opened:type_name -> cubelet.services.cubebox.v1.TerminalOpened
	69,  // 79: cubelet.services.cubebox.v1.TerminalServerFrame.stdout:type_name -> cubelet.services.cubebox.v1.TerminalStdout
	70,  // 80: cubelet.services.cubebox.v1.TerminalServerFrame.exit:type_name -> cubelet.services.cubebox.v1.TerminalExit
	71,  // 81: cubelet.services.cubebox.v1.TerminalServerFrame.error:type_name -> cubelet.services.cubebox.v1.TerminalError
	66,  // 82: cubelet.services.cubebox.v1.TerminalServerFrame.close:type_name -> cubelet.services.cubebox.v1.TerminalClose
	40,  // 83: cubelet.services.cubebox.v1.AppSnapshotRequest.create_request:type_name -> cubelet.services.cubebox.v1.RunCubeSandboxRequest
	113, // 84: cubelet.services.cubebox.v1.AppSnapshotResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	113, // 85: cubelet.services.cubebox.v1.CommitSandboxResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	113, // 86: cubelet.services.cubebox.v1.RollbackSandboxResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	78,  // 87: cubelet.services.cubebox.v1.CleanupTemplateRequest.objects:type_name -> cubelet.services.cubebox.v1.CowObjectRef
	113, // 88: cubelet.services.cubebox.v1.CleanupTemplateResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	78,  // 89: cubelet.services.cubebox.v1.ListSandboxSnapshotsRequest.objects:type_name -> cubelet.services.cubebox.v1.CowObjectRef
	113, // 90: cubelet.services.cubebox.v1.ListSandboxSnapshotsResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	82,  // 91: cubelet.services.cubebox.v1.ListSandboxSnapshotsResponse.objects:type_name -> cubelet.services.cubebox.v1.CowObjectStatus
	113, // 92: cubelet.services.cubebox.v1.ListLocalSnapshotsResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	85,  // 93: cubelet.services.cubebox.v1.ListLocalSnapshotsResponse.snapshots:type_name -> cubelet.services.cubebox.v1.LocalSnapshotInfo
	113, // 94: cubelet.services.cubebox.v1.GetLocalSnapshotResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	85,  // 95: cubelet.services.cubebox.v1.GetLocalSnapshotResponse.snapshot:type_name -> cubelet.services.cubebox.v1.LocalSnapshotInfo
	113, // 96: cubelet.services.cubebox.v1.GetStorageMetricsResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	110, // 97: cubelet.services.cubebox.v1.GetStorageMetricsResponse.metrics:type_name -> cubelet.services.cubebox.v1.GetStorageMetricsResponse.MetricsEntry
	91,  // 98: cubelet.services.cubebox.v1.SandboxStorageInfo.volumes:type_name -> cubelet.services.cubebox.v1.StorageVolumeInfo
	113, // 99: cubelet.services.cubebox.v1.InspectStorageVolumesResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	92,  // 100: cubelet.services.cubebox.v1.InspectStorageVolumesResponse.sandboxes:type_name -> cubelet.services.cubebox.v1.SandboxStorageInfo
	113, // 101: cubelet.services.cubebox.v1.CleanupOrphanStorageFilesResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	96,  // 102: cubelet.services.cubebox.v1.CleanupOrphanStorageFilesResponse.orphans:type_name -> cubelet.services.cubebox.v1.StorageOrphanEntry
	40,  // 103: cubelet.services.cubebox.v1.CubeboxMgr.Create:input_type -> cubelet.services.cubebox.v1.RunCubeSandboxRequest
	48,  // 104: cubelet.services.cubebox.v1.CubeboxMgr.Destroy:input_type -> cubelet.services.cubebox.v1.DestroyCubeSandboxRequest
	54,  // 105: cubelet.services.cubebox.v1.CubeboxMgr.List:input_type -> cubelet.services.cubebox.v1.ListCubeSandboxRequest
	56,  // 106: cubelet.services.cubebox.v1.CubeboxMgr.Update:input_type -> cubelet.services.cubebox.v1.UpdateCubeSandboxRequest
	60,  // 107: cubelet.services.cubebox.v1.CubeboxMgr.Exec:input_type -> cubelet.services.cubebox.v1.ExecCubeSandboxRequest
	62,  // 108: cubelet.services.cubebox.v1.CubeboxMgr.Terminal:input_type -> cubelet.services.cubebox.v1.TerminalClientFrame
	72,  // 109: cubelet.services.cubebox.v1.CubeboxMgr.AppSnapshot:input_type -> cubelet.services.cubebox.v1.AppSnapshotRequest
	74,  // 110: cubelet.services.cubebox.v1.CubeboxMgr.CommitSandbox:input_type -> cubelet.services.cubebox.v1.CommitSandboxRequest
	76,  // 111: cubelet.services.cubebox.v1.CubeboxMgr.RollbackSandbox:input_type -> cubelet.services.cubebox.v1.RollbackSandboxRequest
	79,  // 112: cubelet.services.cubebox.v1.CubeboxMgr.CleanupTemplate:input_type -> cubelet.services.cubebox.v1.CleanupTemplateRequest
	81,  // 113: cubelet.services.cubebox.v1.CubeboxMgr.ListSandboxSnapshots:input_type -> cubelet.services.cubebox.v1.ListSandboxSnapshotsRequest
	84,  // 114: cubelet.services.cubebox.v1.CubeboxMgr.ListLocalSnapshots:input_type -> cubelet.services.cubebox.v1.ListLocalSnapshotsRequest
	87,  // 115: cubelet.services.cubebox.v1.CubeboxMgr.GetLocalSnapshot:input_type -> cubelet.services.cubebox.v1.GetLocalSnapshotRequest
	89,  // 116: cubelet.services.cubebox.v1.CubeboxMgr.GetStorageMetrics:input_type -> cubelet.services.cubebox.v1.GetStorageMetricsRequest
	93,  // 117: cubelet.services.cubebox.v1.CubeboxMgr.InspectStorageVolumes:input_type -> cubelet.services.cubebox.v1.InspectStorageVolumesRequest
	95,  // 118: cubelet.services.cubebox.v1.CubeboxMgr.CleanupOrphanStorageFiles:input_type -> cubelet.services.cubebox.v1.CleanupOrphanStorageFilesRequest
	41,  // 119: cubelet.services.cubebox.v1.CubeboxMgr.Create:output_type -> cubelet.services.cubebox.v1.RunCubeSandboxResponse
	49,  // 120: cubelet.services.cubebox.v1.CubeboxMgr.Destroy:output_type -> cubelet.services.cubebox.v1.DestroyCubeSandboxResponse
	55,  // 121: cubelet.services.cubebox.v1.CubeboxMgr.List:output_type -> cubelet.services.cubebox.v1.ListCubeSandboxResponse
	57,  // 122: cubelet.services.cubebox.v1.CubeboxMgr.Update:output_type -> cubelet.services.cubebox.v1.UpdateCubeSandboxResponse
	61,  // 123: cubelet.services.cubebox.v1.CubeboxMgr.Exec:output_type -> cubelet.services.cubebox.v1.ExecCubeSandboxResponse
	67,  // 124: cubelet.services.cubebox.v1.CubeboxMgr.Terminal:output_type -> cubelet.services.cubebox.v1.TerminalServerFrame
	73,  // 125: cubelet.services.cubebox.v1.CubeboxMgr.AppSnapshot:output_type -> cubelet.services.cubebox.v1.AppSnapshotResponse
	75,  // 126: cubelet.services.cubebox.v1.CubeboxMgr.CommitSandbox:output_type -> cubelet.services.cubebox.v1.CommitSandboxResponse
	77,  // 127: cubelet.services.cubebox.v1.CubeboxMgr.RollbackSandbox:output_type -> cubelet.services.cubebox.v1.RollbackSandboxResponse
	80,  // 128: cubelet.services.cubebox.v1.CubeboxMgr.CleanupTemplate:output_type -> cubelet.services.cubebox.v1.CleanupTemplateResponse
	83,  // 129: cubelet.services.cubebox.v1.CubeboxMgr.ListSandboxSnapshots:output_type -> cubelet.services.cubebox.v1.ListSandboxSnapshotsResponse
	86,  // 130: cubelet.services.cubebox.v1.CubeboxMgr.ListLocalSnapshots:output_type -> cubelet.services.cubebox.v1.ListLocalSnapshotsResponse
	88,  // 131: cubelet.services.cubebox.v1.CubeboxMgr.GetLocalSnapshot:output_type -> cubelet.services.cubebox.v1.GetLocalSnapshotResponse
	90,  // 132: cubelet.services.cubebox.v1.CubeboxMgr.GetStorageMetrics:output_type -> cubelet.services.cubebox.v1.GetStorageMetricsResponse
	94,  // 133: cubelet.services.cubebox.v1.CubeboxMgr.InspectStorageVolumes:output_type -> cubelet.services.cubebox.v1.InspectStorageVolumesResponse
	97,  // 134: cubelet.services.cubebox.v1.CubeboxMgr.CleanupOrphanStorageFiles:output_type -> cubelet.services.cubebox.v1.CleanupOrphanStorageFilesResponse
	119, // [119:135] is the sub-list for method output_type
	103, // [103:119] is the sub-list for method input_type
...
func file_api_services_cubebox_v1_cubebox_proto_init() {
	...
	file_api_services_cubebox_v1_cubebox_proto_msgTypes[56].OneofWrappers = []any{
		(*TerminalClientFrame_Open)(nil),
		(*TerminalClientFrame_Stdin)(nil),
		(*TerminalClientFrame_Resize)(nil),
		(*TerminalClientFrame_Close)(nil),
	}
	file_api_services_cubebox_v1_cubebox_proto_msgTypes[61].OneofWrappers = []any{
		(*TerminalServerFrame_Opened)(nil),
		(*TerminalServerFrame_Stdout)(nil),
		(*TerminalServerFrame_Exit)(nil),
		(*TerminalServerFrame_Error)(nil),
