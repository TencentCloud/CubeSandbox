...
type ImportSnapshotRequest struct {
	...
	// requestID reqID
	RequestID string `protobuf:"bytes,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	// Logical template ID, generated by master (as for a commit).
	TemplateID string `protobuf:"bytes,2,opt,name=templateID,proto3" json:"templateID,omitempty"`
	// Absolute path of the rootfs artifact, under the node import staging dir.
	RootfsSourcePath string `protobuf:"bytes,3,opt,name=rootfs_source_path,json=rootfsSourcePath,proto3" json:"rootfs_source_path,omitempty"`
	// Resource-spec catalog path segment (e.g. "1C1024M"), computed by master.
	SpecDir       string `protobuf:"bytes,4,opt,name=spec_dir,json=specDir,proto3" json:"spec_dir,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ImportSnapshotRequest) GetRequestID() string {
	if x != nil {
		return x.RequestID
	}
	return ""
...
func (x *ImportSnapshotRequest) GetTemplateID() string {
	if x != nil {
		return x.TemplateID
	}
	return ""
...
func (x *ImportSnapshotRequest) GetRootfsSourcePath() string {
	if x != nil {
		return x.RootfsSourcePath
	}
	return ""
}

func (x *ImportSnapshotRequest) GetSpecDir() string {
	if x != nil {
		return x.SpecDir
	}
	return ""
...
type ImportSnapshotResponse struct {
	...
	// Ret.
	Ret *v11.Ret `protobuf:"bytes,2,opt,name=ret,proto3" json:"ret,omitempty"`
	// Logical template ID (echo of the request).
	TemplateID string `protobuf:"bytes,3,opt,name=templateID,proto3" json:"templateID,omitempty"`
	// Snapshot path where the catalog entry was written.
	SnapshotPath string `protobuf:"bytes,4,opt,name=snapshotPath,proto3" json:"snapshotPath,omitempty"`
	// Authoritative cubecow rootfs object name.
	...
	// Rootfs size of the imported artifact.
	RootfsSizeBytes uint64 `protobuf:"varint,7,opt,name=rootfs_size_bytes,json=rootfsSizeBytes,proto3" json:"rootfs_size_bytes,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *ImportSnapshotResponse) GetRequestID() string {
	if x != nil {
		return x.RequestID
	}
	return ""
...
func (x *ImportSnapshotResponse) GetRet() *v11.Ret {
	if x != nil {
		return x.Ret
	}
	return nil
...
func (x *ImportSnapshotResponse) GetTemplateID() string {
	if x != nil {
		return x.TemplateID
	}
	return ""
...
func (x *ImportSnapshotResponse) GetSnapshotPath() string {
	if x != nil {
		return x.SnapshotPath
	}
	return ""
...
func (x *ImportSnapshotResponse) GetRootfsVol() string {
	if x != nil {
		return x.RootfsVol
	}
	return ""
...
func (x *ImportSnapshotResponse) GetRootfsKind() string {
	if x != nil {
		return x.RootfsKind
	}
	return ""
...
func (x *ImportSnapshotResponse) GetRootfsSizeBytes() uint64 {
	if x != nil {
		return x.RootfsSizeBytes
	}
	return 0
...
const file_api_services_cubebox_v1_cubebox_proto_rawDesc = "" +
	...
	"\fenvd_version\x18\x10 \x01(\tR\venvdVersion\"\x9e\x01\n" +
	"\x15ImportSnapshotRequest\x12\x1c\n" +
	"\trequestID\x18\x01 \x01(\tR\trequestID\x12\x1e\n" +
	"\n" +
	"templateID\x18\x02 \x01(\tR\n" +
	"templateID\x12,\n" +
	"\x12rootfs_source_path\x18\x03 \x01(\tR\x10rootfsSourcePath\x12\x19\n" +
	"\bspec_dir\x18\x04 \x01(\tR\aspecDir\"\x9c\x02\n" +
	"\x16ImportSnapshotResponse\x12\x1c\n" +
	"\trequestID\x18\x01 \x01(\tR\trequestID\x124\n" +
	"\x03ret\x18\x02 \x01(\v2\".cubelet.services.errorcode.v1.RetR\x03ret\x12\x1e\n" +
	"\n" +
	"templateID\x18\x03 \x01(\tR\n" +
	"templateID\x12\"\n" +
	"\fsnapshotPath\x18\x04 \x01(\tR\fsnapshotPath\x12\x1d\n" +
	"\n" +
	"rootfs_vol\x18\x05 \x01(\tR\trootfsVol\x12\x1f\n" +
	"\vrootfs_kind\x18\x06 \x01(\tR\n" +
	"rootfsKind\x12*\n" +
	"\x11rootfs_size_bytes\x18\a \x01(\x04R\x0frootfsSizeBytes\"\x89\x02\n" +
	...
	"\x10CONTAINER_PAUSED\x10\x052\x85\x10\n" +
	"\n" +
	"CubeboxMgr\x12q\n" +
	...
	"\rCommitSandbox\x121.cubelet.services.cubebox.v1.CommitSandboxRequest\x1a2.cubelet.services.cubebox.v1.CommitSandboxResponse\x12y\n" +
	"\x0eImportSnapshot\x122.cubelet.services.cubebox.v1.ImportSnapshotRequest\x1a3.cubelet.services.cubebox.v1.ImportSnapshotResponse\x12|\n" +
...
var file_api_services_cubebox_v1_cubebox_proto_goTypes = []any{
	...
	(*ImportSnapshotRequest)(nil),             // 66: cubelet.services.cubebox.v1.ImportSnapshotRequest
	(*ImportSnapshotResponse)(nil),            // 67: cubelet.services.cubebox.v1.ImportSnapshotResponse
	...
	(*v11.Ret)(nil),              // 105: cubelet.services.errorcode.v1.Ret
}
var file_api_services_cubebox_v1_cubebox_proto_depIdxs = []int32{
	...
	104, // 39: cubelet.services.cubebox.v1.VolumeSource.image:type_name -> cubelet.services.images.v1.ImageVolumeSource
	...
	105, // 48: cubelet.services.cubebox.v1.RunCubeSandboxResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	...
	105, // 57: cubelet.services.cubebox.v1.DestroyCubeSandboxResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	...
	105, // 78: cubelet.services.cubebox.v1.ImportSnapshotResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	105, // 79: cubelet.services.cubebox.v1.RollbackSandboxResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	70,  // 80: cubelet.services.cubebox.v1.CleanupTemplateRequest.objects:type_name -> cubelet.services.cubebox.v1.CowObjectRef
	105, // 81: cubelet.services.cubebox.v1.CleanupTemplateResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	70,  // 82: cubelet.services.cubebox.v1.ListSandboxSnapshotsRequest.objects:type_name -> cubelet.services.cubebox.v1.CowObjectRef
	105, // 83: cubelet.services.cubebox.v1.ListSandboxSnapshotsResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	74,  // 84: cubelet.services.cubebox.v1.ListSandboxSnapshotsResponse.objects:type_name -> cubelet.services.cubebox.v1.CowObjectStatus
	105, // 85: cubelet.services.cubebox.v1.ListLocalSnapshotsResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	77,  // 86: cubelet.services.cubebox.v1.ListLocalSnapshotsResponse.snapshots:type_name -> cubelet.services.cubebox.v1.LocalSnapshotInfo
	105, // 87: cubelet.services.cubebox.v1.GetLocalSnapshotResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	77,  // 88: cubelet.services.cubebox.v1.GetLocalSnapshotResponse.snapshot:type_name -> cubelet.services.cubebox.v1.LocalSnapshotInfo
	105, // 89: cubelet.services.cubebox.v1.GetStorageMetricsResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	...
	83,  // 91: cubelet.services.cubebox.v1.SandboxStorageInfo.volumes:type_name -> cubelet.services.cubebox.v1.StorageVolumeInfo
	105, // 92: cubelet.services.cubebox.v1.InspectStorageVolumesResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	84,  // 93: cubelet.services.cubebox.v1.InspectStorageVolumesResponse.sandboxes:type_name -> cubelet.services.cubebox.v1.SandboxStorageInfo
	105, // 94: cubelet.services.cubebox.v1.CleanupOrphanStorageFilesResponse.ret:type_name -> cubelet.services.errorcode.v1.Ret
	88,  // 95: cubelet.services.cubebox.v1.CleanupOrphanStorageFilesResponse.orphans:type_name -> cubelet.services.cubebox.v1.StorageOrphanEntry
	40,  // 96: cubelet.services.cubebox.v1.CubeboxMgr.Create:input_type -> cubelet.services.cubebox.v1.RunCubeSandboxRequest
	48,  // 97: cubelet.services.cubebox.v1.CubeboxMgr.Destroy:input_type -> cubelet.services.cubebox.v1.DestroyCubeSandboxRequest
	54,  // 98: cubelet.services.cubebox.v1.CubeboxMgr.List:input_type -> cubelet.services.cubebox.v1.ListCubeSandboxRequest
	56,  // 99: cubelet.services.cubebox.v1.CubeboxMgr.Update:input_type -> cubelet.services.cubebox.v1.UpdateCubeSandboxRequest
	60,  // 100: cubelet.services.cubebox.v1.CubeboxMgr.Exec:input_type -> cubelet.services.cubebox.v1.ExecCubeSandboxRequest
	62,  // 101: cubelet.services.cubebox.v1.CubeboxMgr.AppSnapshot:input_type -> cubelet.services.cubebox.v1.AppSnapshotRequest
	64,  // 102: cubelet.services.cubebox.v1.CubeboxMgr.CommitSandbox:input_type -> cubelet.services.cubebox.v1.CommitSandboxRequest
	66,  // 103: cubelet.services.cubebox.v1.CubeboxMgr.ImportSnapshot:input_type -> cubelet.services.cubebox.v1.ImportSnapshotRequest
	68,  // 104: cubelet.services.cubebox.v1.CubeboxMgr.RollbackSandbox:input_type -> cubelet.services.cubebox.v1.RollbackSandboxRequest
	71,  // 105: cubelet.services.cubebox.v1.CubeboxMgr.CleanupTemplate:input_type -> cubelet.services.cubebox.v1.CleanupTemplateRequest
	73,  // 106: cubelet.services.cubebox.v1.CubeboxMgr.ListSandboxSnapshots:input_type -> cubelet.services.cubebox.v1.ListSandboxSnapshotsRequest
	76,  // 107: cubelet.services.cubebox.v1.CubeboxMgr.ListLocalSnapshots:input_type -> cubelet.services.cubebox.v1.ListLocalSnapshotsRequest
	79,  // 108: cubelet.services.cubebox.v1.CubeboxMgr.GetLocalSnapshot:input_type -> cubelet.services.cubebox.v1.GetLocalSnapshotRequest
	81,  // 109: cubelet.services.cubebox.v1.CubeboxMgr.GetStorageMetrics:input_type -> cubelet.services.cubebox.v1.GetStorageMetricsRequest
	85,  // 110: cubelet.services.cubebox.v1.CubeboxMgr.InspectStorageVolumes:input_type -> cubelet.services.cubebox.v1.InspectStorageVolumesRequest
	87,  // 111: cubelet.services.cubebox.v1.CubeboxMgr.CleanupOrphanStorageFiles:input_type -> cubelet.services.cubebox.v1.CleanupOrphanStorageFilesRequest
	41,  // 112: cubelet.services.cubebox.v1.CubeboxMgr.Create:output_type -> cubelet.services.cubebox.v1.RunCubeSandboxResponse
	49,  // 113: cubelet.services.cubebox.v1.CubeboxMgr.Destroy:output_type -> cubelet.services.cubebox.v1.DestroyCubeSandboxResponse
	55,  // 114: cubelet.services.cubebox.v1.CubeboxMgr.List:output_type -> cubelet.services.cubebox.v1.ListCubeSandboxResponse
	57,  // 115: cubelet.services.cubebox.v1.CubeboxMgr.Update:output_type -> cubelet.services.cubebox.v1.UpdateCubeSandboxResponse
	61,  // 116: cubelet.services.cubebox.v1.CubeboxMgr.Exec:output_type -> cubelet.services.cubebox.v1.ExecCubeSandboxResponse
	63,  // 117: cubelet.services.cubebox.v1.CubeboxMgr.AppSnapshot:output_type -> cubelet.services.cubebox.v1.AppSnapshotResponse
	65,  // 118: cubelet.services.cubebox.v1.CubeboxMgr.CommitSandbox:output_type -> cubelet.services.cubebox.v1.CommitSandboxResponse
	67,  // 119: cubelet.services.cubebox.v1.CubeboxMgr.ImportSnapshot:output_type -> cubelet.services.cubebox.v1.ImportSnapshotResponse
	69,  // 120: cubelet.services.cubebox.v1.CubeboxMgr.RollbackSandbox:output_type -> cubelet.services.cubebox.v1.RollbackSandboxResponse
	72,  // 121: cubelet.services.cubebox.v1.CubeboxMgr.CleanupTemplate:output_type -> cubelet.services.cubebox.v1.CleanupTemplateResponse
	75,  // 122: cubelet.services.cubebox.v1.CubeboxMgr.ListSandboxSnapshots:output_type -> cubelet.services.cubebox.v1.ListSandboxSnapshotsResponse
	78,  // 123: cubelet.services.cubebox.v1.CubeboxMgr.ListLocalSnapshots:output_type -> cubelet.services.cubebox.v1.ListLocalSnapshotsResponse
	80,  // 124: cubelet.services.cubebox.v1.CubeboxMgr.GetLocalSnapshot:output_type -> cubelet.services.cubebox.v1.GetLocalSnapshotResponse
	82,  // 125: cubelet.services.cubebox.v1.CubeboxMgr.GetStorageMetrics:output_type -> cubelet.services.cubebox.v1.GetStorageMetricsResponse
	86,  // 126: cubelet.services.cubebox.v1.CubeboxMgr.InspectStorageVolumes:output_type -> cubelet.services.cubebox.v1.InspectStorageVolumesResponse
	89,  // 127: cubelet.services.cubebox.v1.CubeboxMgr.CleanupOrphanStorageFiles:output_type -> cubelet.services.cubebox.v1.CleanupOrphanStorageFilesResponse
