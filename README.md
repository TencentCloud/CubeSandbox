...
| **CubeRuntime** | CubeHypervisor and CubeShim together form the virtualization layer — CubeHypervisor drives the KVM MicroVM, while CubeShim bridges it to containerd via the Shim v2 API. |
